<dialog id="note-search" class="note-search-dialog" aria-labelledby="note-search-title">
    <header><h2 id="note-search-title">{{ __('ui.search_notes') }}</h2><button id="close-note-search" type="button" aria-label="{{ __('ui.close') }}"><x-icon name="close" class="close-icon" /></button></header>
