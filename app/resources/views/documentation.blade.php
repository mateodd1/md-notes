...
@push('head')
<style>
    .docs-shell { width:min(100%,880px); min-height:100vh; margin:auto; padding:28px 18px 70px; }.docs-header { display:flex; align-items:center; justify-content:space-between; gap:16px; padding-bottom:24px; border-bottom:1px solid var(--line); }.docs-brand { color:var(--accent); font-weight:800; letter-spacing:-.03em; }.docs-actions { display:flex; flex-wrap:wrap; gap:9px; }.docs-content { max-width:760px; margin:42px auto 0; }.docs-content > :first-child { margin-top:0; }.docs-content h1,.docs-content h2,.docs-content h3 { letter-spacing:-.045em; }.docs-content h1 { margin-bottom:14px; font-size:clamp(32px,5vw,48px); line-height:1; }.docs-content h2 { margin-top:42px; padding-top:9px; border-top:1px solid var(--line); font-size:25px; }.docs-content h3 { margin-top:28px; }.docs-content p,.docs-content li { color:var(--muted); }.docs-content strong { color:var(--ink); }.docs-content a { color:var(--accent); font-weight:650; text-decoration:underline; text-underline-offset:3px; }.docs-content code { padding:.15em .4em; border-radius:5px; background:var(--preview); color:var(--ink); font:600 .88em ui-monospace,SFMono-Regular,Menlo,Monaco,Consolas,monospace; }.docs-content pre { overflow:auto; padding:15px; border-radius:11px; background:var(--preview); border:1px solid var(--line); }.docs-content pre code { padding:0; background:transparent; }.docs-content li + li { margin-top:7px; } @media (max-width:560px) { .docs-header { align-items:flex-start; flex-direction:column; }.docs-content { margin-top:30px; } }
</style>
@endpush
