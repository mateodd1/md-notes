(() => {
    ...
    const bindEditor = () => {
        ...
        saver = new window.MdNotesSaver(() => boundEditor.value, async (content, snapshot) => {
            ...
            boundState.textContent = lastSaveError || (status === 'unsaved' ? t.unsavedChanges : t[status]);
        });
